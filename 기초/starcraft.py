...
#공걱모드 준비 ( 마린 : 스팀팩, 탱크 : 시즈모드, 레이스 : 클로킹)
for unit in attack_units:
    if isinstance(unit,Marine): #현재 유닛이 마린이면 # 지금 객체가 특정클래스의 인스턴스인지 확인
        unit.stimpack()
...
# 전군 피해
for unit in attack_units:
    unit.damaged(randint(5,21)) # 공격 랜덤으로 받음 범위 5~20
